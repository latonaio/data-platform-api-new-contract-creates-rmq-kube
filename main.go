...
import (
	"context"
	dpfm_api_caller "data-platform-api-contract-creates-rmq-kube/DPFM_API_Caller"
	...
	"data-platform-api-contract-creates-rmq-kube/config"
	"data-platform-api-contract-creates-rmq-kube/existence_conf"
...
func getAccepter(input *dpfm_api_input_reader.SDC) []string {
	...
	if accepter[0] == "All" {
		accepter = []string{
			"Header", "Item", "ItemPricingElement", "Partner", "Address",
		}
	}
	return accepter
}
